...
#define configMAX_PRIORITIES			        ( 32 )                              //可使用的最大优先级，优先级数字越低，任务优先级越低
...
#define configCHECK_FOR_STACK_OVERFLOW	        0                                   //大于0时启用堆栈溢出检测功能，如果使用此功能用户必须提供一个栈溢出钩子函数，
...
#define configUSE_TICK_HOOK                     0                                   //1，使用tick滴答定时器钩子；0，不使用
...
#define configUSE_CO_ROUTINE_PRIORITIES         ( 2 )                               //协程的有效优先级数目
